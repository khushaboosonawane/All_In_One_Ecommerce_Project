...
<body>
    <div class="container-fluid" style="background:black;">
        <div class="row hideinprint">
            ...
            <div class="col-md-12">
                <nav class="navbar navbar-expand-lg navbar-light bg-light shadow" style="background-color:white !important;color:black;box-shadow:0 0 20px gray !important;">
                    <div class="container-fluid">
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="<?= base_url() ?>usercontroller/">Home</a>
                            </li>
                            <?php
                            if(count($category)>0){
